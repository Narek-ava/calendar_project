...
export default function themePalette(theme: CustomTypography) {
    return {
        ...
        widget: {
            bgTop: theme.colors?.widgetBgTop,
            bgBottom: theme.colors?.widgetBgBottom,
            title: theme.colors?.widgetTitle,
            text: theme.colors?.widgetText,
            green: theme.colors?.widgetGreen,
            lightGreen: theme.colors?.widgetLightGreen,
            darkGreen: theme.colors?.widgetDarkGreen,
            buttonDetails: theme.colors?.widgetButtonDetails
        }
    };
}
