...
Route::get('/mailbox/{mailbox_id}/new-message', 'ConversationsController@create')->name('conversations.create');
...
// Mailgun incoming webhook for forwarded messages
Route::post('/mailgun-route-forward', 'CB\MailgunIncomingController@handleForwarded')->name('cb.mailgun.forward');

Route::get('/customer-profile', 'ConversationsController@customerProfileIframe')->name('customer_profile.iframe');