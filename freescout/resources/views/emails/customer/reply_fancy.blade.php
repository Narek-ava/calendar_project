...
<body style="-webkit-text-size-adjust:none;">
	<div id="{{ App\Misc\MailHelper::REPLY_SEPARATOR_HTML }}" class="{{ App\Misc\MailHelper::REPLY_SEPARATOR_HTML }}" style="width:100%!important; margin:0; padding:0">
		...
		@if (\App\Option::get('email_branding'))
            <div height="" style="height:30px; font-size:12px; line-height:18px; font-family:Arial,'Helvetica Neue',Helvetica,Tahoma,sans-serif; color: #aaaaaa;">
				{!! __('Support powered by :app_name', ['app_name' => '<a href="'.Config::get('app.url').'">'.\Config::get('app.name').'</a>']) !!}
			</div>
		@endif
