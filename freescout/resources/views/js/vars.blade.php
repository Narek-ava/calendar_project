...
var LangMessages = {
    @foreach ($locales as $locale)
        ...
        "{{ $locale }}.messages": {
            ...
            "error_occured_updating": "{{ __('Error occured. Please try again or try another :%a_start%update method:%a_end%', ['%a_start%' => '<a href="'.config('app.url').'/docs/update/" target="_blank">', '%a_end%' => '</a>']) }}",
