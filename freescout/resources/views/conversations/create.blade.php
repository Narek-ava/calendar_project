            ...
            <div id="conv-toolbar">
                ...
                <div class="conv-actions">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-default" id="twilio-conv-switch" onclick="switchToNewTwilioConversation({{ App\Conversation::TYPE_CHAT }})"><i class="glyphicon glyphicon-phone"></i></button>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal margin-top form-reply" method="POST" action="" id="form-create">
                            ...
                            <div class="form-group twilio-conv-fields{{ $errors->has('phone') ? ' has-error' : '' }}">
                                <label for="phone" class="col-sm-2 control-label">{{ __('Phone') }}</label>

                                <div class="col-sm-9">

                                    <select class="form-control draft-changer" name="phone" id="phone" multiple>
                                        @if (!empty($phone))
                            ...
                            <div class="form-group sub-conv-fields{{ $errors->has('subject') ? ' has-error' : '' }}">
