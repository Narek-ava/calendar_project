...
class Folder extends Model
{
    ...
    {
        if (\Module::isActive('globalmailbox') && $mailbox_id == \GlobalMailbox::MAILBOX_ID) {
            return \Eventy::filter('folder.url', route('globalmailbox.view.folder', ['folder_type_id'=>$this->id]), $mailbox_id, $this);
        }
