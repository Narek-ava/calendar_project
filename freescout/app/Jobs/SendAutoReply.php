...
class SendAutoReply implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        \App\Misc\MailHelper::setMailDriver($this->mailbox, null, $this->conversation);
        ...
        $message_id = \App\Misc\MailHelper::MESSAGE_ID_PREFIX_AUTO_REPLY.'-'.$this->thread->id.'-'.md5($this->thread->id).'@'.$this->mailbox->getEmailDomain();
