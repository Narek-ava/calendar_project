...
class Conversation extends Model
{
     ...
     */
    const RECENT_CONVERSATION = 'recent';
    const PREVIOUS_CONVERSATION = 'previous';
    ...
    public function getFullTitle(): string
    {
        ...
        $customerFullName = $customer ? " - {$customer->getFullName(true)}" : '';
        return "#$this->number {$this->getSubject()}$customerFullName";
    }
     ...
     */
    public static function getQueryByFolder($folder, $user_id, $q = null, $conversationId = null)
    {
    ...
    static public function getConversationsIdDuringSearch(string $q)
    {
    ...
    public static function refreshConversations($conversation, $thread)
    {
        ...
        \App\Events\RealtimeMailboxNewThread::dispatchSelf($conversation);
    }
