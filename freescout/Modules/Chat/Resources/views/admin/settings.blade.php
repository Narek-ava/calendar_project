            ...
            <div id="chat-widget-form">
                ...
                <div class="form-group @if (empty($widget_settings)) hidden @endif" id="chat-widget-code-wrapper">
                    ...
                    <div class="col-sm-6 col-sm-offset-2">
                        <textarea rows="5" readonly class="disabled form-control" id="chat-widget-code">&lt;!-- Chat BEGIN --&gt;
&lt;script&gt;var ChatW={s:{{ \Helper::jsonEncodeUtf8($widget_settings) }}{{ '}' }};(function(d,e,s){if(d.getElementById(&quot;chat-w&quot;))return;a=d.createElement(e);m=d.getElementsByTagName(e)[0];a.async=1;a.id=&quot;chat-w&quot;;a.src=s;m.parentNode.insertBefore(a, m)})(document,&quot;script&quot;,&quot;{{ \Chat::getWidgetScriptUrl($mailbox->id, true) }}&quot;);&lt;/script&gt;
&lt;!-- Chat END --&gt;</textarea>
...
{{--                        @endif--}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-sm-offset-2">
                    ...
                    @if (!\Module::isActive('enduserportal'))
                        <div class="alert alert-info">{!! __(":%a_begin%End-User Portal Module:%a_end% is required.", ['%a_begin%' => '<strong>', '%a_end%' => '</strong>']) !!}</div>
                    @endif
                </div>
            </div>
            ...
            @if (\Module::isActive('enduserportal'))
                ...
                @if ($eup_update)
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-2">
                            <div class="alert alert-info">{!! __(":%a_begin%End-User Portal Module:%a_end% is required.", ['%a_begin%' => '<strong>', '%a_end%' => ' (> v1.0.9)</a>']) !!}</div>
                        </div>
                    </div>
                @else
                    <div class="form-group">
