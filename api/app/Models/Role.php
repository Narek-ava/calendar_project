...
class Role extends Model implements RoleContract
{
    ...
    public const FRONTDESK_ROLE = 'frontdesk';
    public const READ_ONLY_LIMITED_ROLE = 'read_only_limited';
    ...
    public static array $availableRoles = [
        ...
        self::PROVIDER_ROLE,
        self::FRONTDESK_ROLE,
        self::READ_ONLY_LIMITED_ROLE
    ];

    public static array $defaultRoles = [
        [
        ...
        [
            'name'        => self::READ_ONLY_LIMITED_ROLE,
            'level'       => 6,
     ...
     * @return RoleContract
     */
    public static function findByName(string $name, $guardName = 'web', int $teamId = null): RoleContract
    {
        ...
        $role = static::findByParam([
            ...
            PermissionRegistrar::$teamsKey => $teamId,
        ]);
