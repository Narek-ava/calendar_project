...
class AppointmentStatusCanceledNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        $message = (new MailMessage)
            ...
            ->markdown('emails.appointment.employee.status-canceled', [
            ...
            ->cc($this->appointment->company->email ?? []);
    ...
    public function toTwilio(User $notifiable): TwilioSmsMessage|TwilioMessage
    {
        ...
        return (new TwilioSmsMessage())->content("Your appointment with $customer->firstname $customer->lastname on $date has been canceled");
    }
