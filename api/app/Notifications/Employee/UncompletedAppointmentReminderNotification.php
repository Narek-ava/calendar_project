...
class UncompletedAppointmentReminderNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Incomplete Appointment Reminder')
            ->markdown('emails.appointment.employee.uncompleted-appointments', [
