...
class AppointmentStatusCanceledNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(Customer $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->markdown('emails.appointment.customer.status-canceled', [
    ...
    public function toTwilio(Customer $notifiable): TwilioSmsMessage|TwilioMessage
    {
        ...
        $message = "Hey, $customer->firstname! Your appointment with $employeeUser->firstname at $company->name has been canceled";
