...
class AppointmentReminderNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(Customer $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->markdown('emails.appointment.customer.reminder', [
    ...
    public function toTwilio(Customer $notifiable): TwilioSmsMessage|TwilioMessage
    {
        ...
        $message = "Hey, $customer->firstname! Just a friendly reminder of your appointment with $employeeUser->firstname at $company->name on $date. For details check $shortUrl";
